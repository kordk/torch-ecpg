...
def run_comparison_test(test_name, M, G, C, M_annot=None, G_annot=None, logit_transform=False, **kwargs):
    ...
    try:
        # Note: check_index_type=False guards a known object-vs-str index dtype asymmetry
        # between processing.py and regression_full.py. This is tracked as a separate follow-up.
        # With the seeded, non-empty fixture, the value comparison is now the meaningful check.
